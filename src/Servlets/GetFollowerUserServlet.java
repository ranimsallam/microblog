...
/**
 * Servlet implementation class GetFollowerUserServlet
 */
@SuppressWarnings("deprecation")
public class GetFollowerUserServlet extends HttpServlet implements SingleThreadModel {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetFollowerUserServlet() {
        super();
    }
	 ...
	 * @param response followers if users
...
try {
    		...
    		if (uri.indexOf(AppConstants.USERNAME) != -1){
    			...
    			try {
    				...
    				//get the followers of username ordered by user popularity
    				stmt = conn.prepareStatement(AppConstants.GET_FOLLOWERS);
        				
        			stmt.setString(1, nickname);
        			rs = stmt.executeQuery();
        			int followerCounter = 0;
        			//insert into collection the top 10 followers ordered by popularity
        			while (rs.next() && followerCounter < 10){
